...
var EntityMovementCollisionSystem = require('./systems/entityMovementCollisionSystem');
var BulletCollisionSystem = require('./systems/bulletCollisionSystem');
var EnemyAttackSystem = require('./systems/enemyAttackSystem');
...
Server.prototype._addSystems = function() {
    ...
    this._engine.addSystem(new EntityMovementCollisionSystem(this._engine), 2);
    this._engine.addSystem(new BulletCollisionSystem(this._engine), 3);
    this._engine.addSystem(new EnemyAttackSystem(this._engine), 3.5);
